...
namespace Lib6502.Tests
{
    public class BCCTests
    {
        ...
        [Test]
        public void BCC_WithCarrySet_ProgramCounterStaysTheSame()
        {
            sut.PC = 0x1000;
        ...
        [Test]
        public void BCC_WithCarrySetAndOnPageAddress_ProgramCounterChanges()
        {
            sut.PC = 0x1000;
        ...
        [Test]
        public void BCC_WithCarrySetAndOffPageAddress_ProgramCounterChanges()
        {
            sut.PC = 0x1000;
